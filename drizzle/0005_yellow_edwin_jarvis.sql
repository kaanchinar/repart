...
ALTER TABLE "user" ALTER COLUMN "phone_number_verified" DROP DEFAULT;--> statement-breakpoint
...
ALTER TABLE "passkey" DROP COLUMN "webauthn_user_id";--> statement-breakpoint
ALTER TABLE "user" DROP COLUMN "role";--> statement-breakpoint
ALTER TABLE "user" DROP COLUMN "payout_card_pan";